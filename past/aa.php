...
session_start();
$pdo = new PDO('mysql:host=mysql1.php.xdomain.ne.jp;dbname=ogu10_01;charset=utf8','ogu10_001','jobins2022');
...
$stmt = $pdo -> prepare("INSERT INTO players(No,name,team,age) VALUES(:No,:name,:team,:age)");//登録準備
