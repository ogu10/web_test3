...
<font color='white'><div align='center'><br>
        <body background="images/0_<?php echo rand(3,6); ?>.jpg"></body>
        <head>
            <meta charset="UTF-8">
...
<form action="" method="post">
    ...
    <button type="submit" name="datapost" style="cursor:pointer" disabled="disabled">
    ...
    <p><h1><font color='Green'><div style="padding: 10px; margin-bottom: 10px; width:300px; border: 5px double #333333; background-color: #e0ff80;">
                ...
                <a href="players_list4.php">Answer list</a></h1></form></div>
</p>
